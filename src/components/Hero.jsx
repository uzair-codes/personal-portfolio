...
const Hero = ({ id }) => {
  return (
    <section
      id={id}
      className="scroll-mt-20 min-h-screen flex flex-col items-center justify-center relative bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 py-16"
    >
      <div className="max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          I’m passionate about leveraging cloud technologies and artificial intelligence to solve
          real-world problems. Let’s connect and build something innovative together.
        </motion.p>
      ...
      {/* 🔽 Animated Down Arrow to Scroll to About Section */}
      <motion.a
        href="#about"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: [0, 10, 0] }}
        transition={{ delay: 1.5, repeat: Infinity, duration: 2 }}
        className="absolute bottom-6 text-blue-600 dark:text-blue-400 hover:text-purple-600 transition-colors"
