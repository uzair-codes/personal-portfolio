  ...
  const allProjects = [
    {
      id: 1,
      title: "NetWhiz",
      description: "AI-powered smart troubleshooting assistant for telecom networks.",
      tags: ["AI", "Networking"],
      demoLink: "https://huggingface.co/spaces/uzair-codes/NetWhiz",
      status: "complete",
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      title: "Transcriber",
      description: "Audio-to-text transcription app using Whisper and Streamlit.",
      tags: ["AI"], // 🔥 Updated tag list
      demoLink: "https://huggingface.co/spaces/uzair-codes/Transcriber",
      status: "complete",
    },
    {
      id: 4,
      title: "Cloud Resource Optimizer",
      description: "AI-powered advisor for cloud cost and performance optimization.",
      tags: ["AI", "Cloud"],
      status: "coming",
    },
    {
      id: 5,
      title: "Protocol Flow Visualizer",
      description: "AI-based packet flow visualizer for protocols like TCP/IP.",
      tags: ["AI", "Networking"],
      status: "coming",
    },
    {
